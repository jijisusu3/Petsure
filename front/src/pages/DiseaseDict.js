        ...
        >
          <Box sx={style}>
            ...
            <div>
              ...
              <p className={classes.info}>평소 털 관리를 잘 하고, 미끄럼 방지 매트를 깔아주세요.</p>
      ...
      <div>
        ...
        >
          <Box sx={style}>
            ...
            <div>
              ...
              <p className={classes.info}>귀가 건조하게 유지될 수 있도록 목욕 후 잘 말려주세요.</p>
            </div>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style}>
            ...
            <div>
              <p className={classes.dText}>이렇게 하는게 좋아요.</p>
              <p className={classes.info}>면역력을 높이기 위해 영양가 있는 식사를 급여해주세요.</p>
              <p className={classes.info}>
